...
// ** Component
import PrivacySchema from '@/components/schema/PrivacySchema';
...
export const metadata: Metadata = {
    ...
    description:
        "Chính sách bảo mật của Ztruyện. Tìm hiểu cách chúng tôi thu thập, sử dụng và bảo vệ thông tin cá nhân khi bạn sử dụng website đọc truyện trực tuyến.",
    ...
    openGraph: {
        ...
        title: "Chính sách bảo mật | Ztruyện",
        description:
            "Tìm hiểu cách Ztruyện thu thập, sử dụng và bảo vệ dữ liệu cá nhân của người dùng khi đọc truyện trên nền tảng.",
        siteName: "Ztruyện",
        ...
        images: [
            {
                ...
                width: 1200,
                height: 630,
                alt: "Ztruyện - Đọc truyện tranh online",
            },
        ],
    },
    ...
    twitter: {
        ...
        title: "Chính sách bảo mật | Ztruyện",
        description:
            "Chính sách bảo mật của Ztruyện khi sử dụng nền tảng đọc truyện trực tuyến.",
        images: ["/bg.png"],
    },
}
