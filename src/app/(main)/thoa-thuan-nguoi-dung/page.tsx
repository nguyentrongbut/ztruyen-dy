...
// ** Component
import TermsSchema from '@/components/schema/TermsSchema';
...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: '/thoa-thuan-nguoi-dung',
    },
            ...
            <main className="min-h-screen bg-background">
                <div className="container px-4 py-8 sm:py-12 lg:py-16">
                    ...
                    <p className="mb-8 max-w-3xl text-sm leading-relaxed text-muted-foreground sm:text-base">
                        Vui lòng đọc kỹ Thỏa thuận người dùng trước khi sử dụng
                        ZTruyen. Khi truy cập hoặc sử dụng website, bạn đồng ý
                        tuân thủ toàn bộ các điều khoản và điều kiện được nêu
                        dưới đây.
                    </p>
                    ...
                    <div className="space-y-8 text-sm leading-7 sm:space-y-10 sm:text-base sm:leading-8">
                        ...
                        <section>
                            ...
                            <p className="text-muted-foreground">
                                ZTruyen là nền tảng đọc truyện trực tuyến, cung
                                cấp giao diện và các công cụ hỗ trợ người dùng
                                tiếp cận nội dung truyện một cách thuận tiện và
                                thân thiện.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <p className="text-muted-foreground">
                                Toàn bộ dữ liệu truyện tranh, hình ảnh và thông
                                tin chi tiết được tổng hợp từ{' '}
                            ...
                            <p className="mt-2 text-muted-foreground">
                                ZTruyen không sở hữu, không lưu trữ và không
                                chịu trách nhiệm bản quyền đối với nội dung
                                truyện được cung cấp từ bên thứ ba.
                            </p>

                            <p className="mt-2 text-muted-foreground">
                                Mọi vấn đề liên quan đến bản quyền vui lòng liên
                                hệ trực tiếp với đơn vị sở hữu nội dung.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <p className="mb-3 text-muted-foreground">
                                ZTruyen phát triển các tính năng bổ sung thông
                                qua hệ thống API nội bộ:
                            </p>
                        ...
                        <section>
                            ...
                            <p className="text-muted-foreground">
                                Dữ liệu tài khoản như tên đăng nhập, bình luận,
                                lịch sử đọc được lưu trữ và quản lý bởi hệ thống
                                ZTruyen.
                            </p>

                            <p className="mt-2 text-muted-foreground">
                                Chúng tôi cam kết bảo mật dữ liệu người dùng và
                                không chia sẻ cho bên thứ ba, trừ khi có yêu cầu
                        ...
                        <section>
                            ...
                            <p className="mt-2 text-muted-foreground">
                                ZTruyen có quyền xóa nội dung hoặc khóa tài
                        ...
                        <section>
                            ...
                            <ul className="list-disc space-y-1 pl-5 text-muted-foreground">
                                ...
                                <li>
                                    Thiệt hại phát sinh trong quá trình sử dụng
                                </li>
                            </ul>
                        </section>
                        ...
                        <section>
                            ...
                            <p className="text-muted-foreground">
                                ZTruyen có thể cập nhật điều khoản bất kỳ lúc
                                nào. Việc tiếp tục sử dụng website đồng nghĩa
                        ...
                        <section>
                            ...
                            <p className="text-muted-foreground">
                                Mọi thắc mắc hoặc phản hồi vui lòng liên hệ đội
                                ngũ quản trị ZTruyen qua Fanpage.
                            </p>
                        </section>
                    </div>
                </div>
