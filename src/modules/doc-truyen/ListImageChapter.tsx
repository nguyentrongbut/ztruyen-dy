...
// ** Types
import { IOtruyenDetailComic, TOtruyenChapter, TOtruyenChapterImage } from '@/types/api';
    ...
    return (
        <>
            ...
            <ImageSaver
                ...
                slug={slugComic}
                name={listDetailComic.name}
                path={`/${CONFIG_SLUG.READING}/${path}`}
                image={listDetailComic.thumb_url}
